    ...
    computed: {
        mainUrl: {
            get() {
                ...
                if (storage) {
                    return storage.AuthStore.rootDomain + storage.AuthStore.MainURL;
                } else {
                    return this.$store.state.AuthStore.rootDomain + this.$store.state.AuthStore.MainURL;
                }
            }
        },
        mainUrlStorage: {
            get() {
                let storage = JSON.parse(localStorage.getItem("vuexDatabase"));
                if (storage) {
                    return storage.AuthStore.rootDomain + storage.AuthStore.MainStorageURL;
                } else {
                    return this.$store.state.AuthStore.rootDomain + this.$store.state.AuthStore.MainStorageURL;
                }
            }
        },
        userData: {
